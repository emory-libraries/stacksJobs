...
Author: Alex Cooper
Date: 12/04/2017
Purpose: Run the change items policy job for Oxford's Stacks team
=end
...
begin
    job_xml = File.open("/sirsi/webserver/bin/stacks_jobs/files/job_oxfd_regular.xml")
    values = job_xml.read
    values = values.chomp
rescue
