...
begin
    configuration = File.open("/sirsi/webserver/bin/stacks_jobs/files/create_set.cfg")
rescue
    STDERR.puts 'Could not read configuration file'
end
# reads set xml
begin
    xml = File.open("/sirsi/webserver/bin/stacks_jobs/files/new_set.xml")
rescue
...
if outcome == 0
    ...
    File.write('/sirsi/webserver/bin/stacks_jobs/files/setId', setId)
#    puts setId
end
